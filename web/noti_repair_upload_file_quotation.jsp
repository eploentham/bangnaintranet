...
<html>
    ...
    <body>
                 ...
                 if (mrequest != null) todo = mrequest.getParameter("todo");
                     if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
                     {
                        ...
                        {                            
                            ...
                            notirepair.setNotiRepairPictureQuotationDelete();
                            ...
                            file.setFileName(noti_repair_id+"_quotation.jpg");
        ...
        <form method="post" action="noti_repair_upload_file_quotation.jsp" name="upform" enctype="multipart/form-data">
            <table width="60%" border="0" cellspacing="1" cellpadding="1" align="center" class="style1">
                <tr>
                  <td align="left"><b>Select a file to upload[<%out.print(noti_repair_id);%> ]:</b></td>
                </tr>
                <tr>
                  <td align="left">
