...
//txt_reportname="doctor_dx_groupby_typepayment";
    ...
    txt_critiria_branch = "<tr> <td class='style14' width='100'>สาขา</td> "
                +"<td colspan='5' class='style14' width='250'>"
                +"<select name='cbo_branch' id='cbo_branch'> "
                +txt_cbo_branch+"</select>&nbsp; "
                +"</td> </tr>";
    txt_critiria1 = "<tr> <td class='style14' width='100'>ประจำวันที่</td> "
                ...
                +"<!--<td class='style14'></td>--> "
                +"<td class='style14' width='100'>ถึงวันที่</td> "
                ...
                +"</td> </tr>";
    txt_critiria2 = "<tr><td class='style14'>ประเภทสิทธิ</td> "
    ...
    //txtcritiria2="";// ไม่มี ถ้ามีค่อยมาเพิ่ม
        txt_critiria3="<tr><td class='style14'>เงื่อนไข เพศ</td>"
                ...
                +"<input type='radio' name='chk_status_sex' value ='2' id='chk_status_sex' onClick='changeselecttime(graph);'>หญิง</label></td>"
                +"</tr> ";
        txt_critiria4="<tr><td class='style14'>เงื่อนไข LAB</td>"
                +"<td colspan='5' class='style14'><label> "
                +"<select name='cbo_lab' id='cbo_lab'> "
                +txt_cbo_lab+"</select> </td>"
                +"</tr> ";
        txt_critiria5 = "<tr> <td class='style14' width='100'>เงื่อนไข age</td> "
                +"<td colspan='2' class='style14' width='250'>"
                ...
                +"</td> </tr>";
        txt_critiria6="<tr><td class='style14'>เงื่อนไข </td>"
                +"<td colspan='2' class='style14'><label> "
                +"<input type='radio' name='chk_status_lab' value='noshow' id='chk_status_lab' checked onClick='changeselecttime(report);'> "
                +"ไม่แสดงผล LAB</label> </td>"
                +"<td colspan='3' class='style14'><label> "
                +"<input type='radio' name='chk_status_lab' value ='show' id='chk_status_lab' onClick='changeselecttime(graph);'>แสดงผล LAB</label></td>"
                +"</tr> ";
%>
<html>
    <head>
