<%-- 
    Document   : rpt_critiria_monthly_doctor_admit
    Created on : 16 ก.ค. 2552, 13:58:38
    Author     : pop
--%>
...
String txtcbomonth="", txtcboyear="", cbotime="", flag="", txtcreitria3time="",txtcritiriabranch="";
...
if(request.getParameter("txt_report_name")!=null){
    ...
    txt_reportname="yearly_doctor_admit";
    }
...
<html>
    ...
    <body>
        <form name="rpt_critiria_monthly_doctor_admit" method="post" action="rpt_report_view.jsp">
        <table width="606" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        ...
                        <td width="80" class="style14" colspan="2">
                          ...
                          <input type="hidden" name="txt_form" id="txt_form" value="yearly">
                          </label></td>
    ...
    <script>
      function changeselecttime(flag) {
        document.forms[0].action = "rpt_critiria_monthly_doctor_admit.jsp?flag="+flag;
