...
if(request.getParameter("txt_report_name")!=null) {
    ...
    txt_reportname="daily_patient_admit_ward";
    }
...
<html>
    ...
    <body>
        <form name="rpt_critirai_daily_patient_admit" method="post">
   ...
   onClick="cal.select(document.forms['rpt_critirai_daily_patient_admit'].txt_date_start,'anchor1','dd/MM/yyyy'); return false;"
   ...
   onClick="cal.select(document.forms['rpt_critirai_daily_patient_admit'].txt_date_end,'anchor2','dd/MM/yyyy'); return false;"
   NAME="anchor2" ID="anchor2">&nbsp; <img src="images/cal.gif" alt="" width="16" height="16" border="0"></A>
                      ...
                      <tr>
                        ...
                        <td class="style14"  >
                            <label ><input type="radio" name="chk_status" value="detail" id="status_1"  disabled />รายละเอียด</label>&nbsp;&nbsp;
        <label><input type="radio" name="chk_status" value="sum" id="status_1"  />สรุป</label>
                        </td>
