...
//txt_reportname="doctor_dx_groupby_typepayment";
    ...
    txtcritiria2 = "<tr><td class='style14'>ประเภท</td> "
        ...
        txtcritiria3="<tr><td class='style14'>เงื่อนไข</td>"
                ...
                +"<input type='radio' name='chk_status_daynight' value ='night' id='status_night' onClick='changeselecttime(night);'>กลางคืน</label></td>"
                +"</tr>"
                +"<tr><td class='style14'> </td> "
                +"<td colspan='2' class='style14'><label> "
                +"<input type='radio' name='chk_status_daynight' value='all' id='status_all' onClick='changeselecttime(time);'> "
                +"ไม่ระบุช่วงเวลา</label> </td>"
                +"<td colspan='2' class='style14'><label> "
                +"<input type='radio' name='chk_status_daynight' value='time' id='status_time' onClick='changeselecttime(time);'> "
                +"ระบุช่วงเวลา</label> </td>";
                if(flag.equals("time")) {
                    txtcreitria3time="<td colspan='3' class='style14'><label> เวลาเริ่มต้น&nbsp; "
        ...
        txtcritiria4="<tr><td class='style14'>เงื่อนไข</td>"
                +"<td colspan='2' class='style14'><label> "
